...
export default defineComponent({
  ...
  setup(props, {emit, expose}) {
    ...
    return {
      containerActive, // container active class
      containerSuccess, // container success class
      containerFail, // container fail class
      canvasCtx,
      blockCtx,
      block,
      canvasDocm,
      ...
      success, // Bug Fixes 修复了验证成功后还能滑动
      loadBlock, // Features 图片加载提示，防止图片没加载完就开始验证
      timestamp,
      touchStartEvent,
      touchMoveEvent,
      touchEndEvent,
